        ...
        <div className='sticky top-0 z-[10] drop-shadow-lg py-[5px] w-[100%] px-[10px] bg-[#f2f2f2] sm:py-[10px] sm:px-[10px]'>
            ...
            <div className='flex justify-between items-center w-[100%] max-lg:flex-wrap lg:px-[55px]'>
                ...
                <div className='flex justify-between items-center max-lg:order-2'>
                    ...
                    <div onClick={() => { }} className='relative flex flex-col justify-center items-center w-[30px] lg:w-[50px] cursor-pointer'>
                        ...
                        <span className='w-[10px] h-[10px] max-lg:top-[-24%] max-lg:right-[-14%] sm:w-[21px] sm:h-[21px] leading-[18px] text-center absolute top-[-10%] border border-mainColor right-[0%] shadow-2xl bg-white text-[15px] max-lg:text-[12px] sm:text-[13px] rounded-full flex justify-center items-center p-[8px] text-[#2c2c2c]'>{0}</span>
                    </div>
                </div>
            </div >
        </div >
